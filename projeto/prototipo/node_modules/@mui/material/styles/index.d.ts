export { default as THEME_ID } from 'mui/material/styles/identifier';
export {
...
export { default as createColorScheme } from 'mui/material/styles/createColorScheme';
...
export * from '@mui/material/styles/ThemeProviderWithVars';

export { default as extendTheme } from '@mui/material/styles/createThemeWithVars';
...
export { default as shouldSkipGeneratingVar } from 'mui/material/styles/shouldSkipGeneratingVar';
