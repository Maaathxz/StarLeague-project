...
export { default as slotShouldForwardProp } from 'mui/material/styles/slotShouldForwardProp';
export { default as rootShouldForwardProp } from 'mui/material/styles/rootShouldForwardProp';
